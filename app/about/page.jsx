  ...
  return (
    <main className="min-h-screen p-4 pt-12 sm:p-12 w-[80%] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="sm:w-2/3 font-light tracking-wide leading-normal sm:pr-4">
        ...
        <div className="sm:w-1/3 mt-8 mb-8 sm:mb-8 sm:mt-0 border-0 rounded-xl bg-foreground/10 backdrop-blur p-4 shadow-inner shadow-lg">
